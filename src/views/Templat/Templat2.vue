<template>
    <div>
      ...
      <p class="text1">{{ current_text }}</p>
      <canvas id="myCanvas" style="display: none" ></canvas>


      <p class="bytext">by {{ personData.nickname }}</p>

      <p class="date_text1">{{current_date[2]}}</p>
      <p class="date_text2">{{current_date[3] }}.{{current_date[1]}}</p>
      <p class="date_text3">{{current_date[0]}}</p>
    ...
    methods: {
      ...
      canvas2img () {
        ...
        qr.onload = function () {
          ...
          cxt.fillText(that.current_text.slice(0, 25), 20, 1110 * 0.65)
          cxt.fillText(that.current_text.substring(25), 20, 1110 * 0.7)
          cxt.drawImage(qr, 750 - 130, 1110 - 150, 100, 100)
          cxt.fillStyle = '#000000'
          cxt.font = '20px impact'
          cxt.fillText('扫我一下啊', 750 - 130, 1110 - 25)
          cxt.fillStyle = '#ffffff'
          cxt.font = 'normal normal bold 140px Arial'
          cxt.fillText(that.current_date[2], 20, 1110 * 0.92)
          cxt.font = 'normal normal normal 28px Arial'
          cxt.fillText(that.current_date[3] + '.' + that.current_date[1], 20, 1110 * 0.95)
          cxt.font = 'normal normal normal 24px Arial'
          cxt.fillText(that.current_date[0], 20, 1110 * 0.98)
          cxt.font = 'normal normal normal 28px Arial'
          cxt.fillText('by' + that.personData.nickname, 20, 1110 * 0.77)
        }
        setTimeout(function () {
